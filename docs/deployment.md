...
- Add secrets at `https://github.com/hanneslsm/studio25/settings/secrets/actions`.
...
3. Draft a release at `https://github.com/hanneslsm/studio25/releases` with a `v` tag (e.g. `v3.0.0`).
